...
exports.interceptorJWT = function(request, response, next){
    ...
    //Temporal ------validar que PETICIONES VAN AQUI
   
    /*
            if(request.url == "/login" || (request.method.toUpperCase()=="POST") ||
            request.url == "/usuarios" || (request.method.toUpperCase()=="GET") ||
            request.url == "/comprobarlogin" || (request.method.toUpperCase()=="POST")
